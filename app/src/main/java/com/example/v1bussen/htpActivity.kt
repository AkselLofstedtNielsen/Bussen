...
class htpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        htpTextView.text = "Bussen går ut på att klara alla fyra nivåer,  börja spelet genom att trycka på kortet nere till höger. " +
                "Sedan ska användaren trycka på valfritt kort i första raden samt gissa (Högre/Lägre) eller (Samma eller inte samma färg). " +
